...
class LoginTestElectronics_1 extends Simulation {
  ...
  val feeder = csv("/home/dell/LPS/gatling-charts-highcharts-bundle-2.3.1/user-files/CSV_Folder/LoginTest1.csv")
